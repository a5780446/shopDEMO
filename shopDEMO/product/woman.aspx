<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="woman.aspx.cs" Inherits="shopDEMO.product.woman" %>
                ...
                <tr>
                    ...
                    <td class="auto-style6">
                        <asp:Panel ID="Panel3" runat="server" Height="529px">
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:memberConnectionString %>" SelectCommand="SELECT[id], [model], [price], [image] FROM [product] where id like '2%'"></asp:SqlDataSource>
                            ...
                            商品尚未結帳<asp:DataList ID="DataList2" runat="server" DataSourceID="SqlDataSource1" RepeatDirection="Horizontal" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="0" GridLines="Both" OnItemCommand="DataList2_ItemCommand" CssClass="auto-style7" RepeatColumns="4" Height="500px" Width="500px">
                                ...
                                <ItemStyle BackColor="#FDCEEE" ForeColor="#003399" />
                                <ItemTemplate>
