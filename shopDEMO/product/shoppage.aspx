                ...
                <tr>
                    ...
                    <td class="auto-style6">
                        <asp:Panel ID="Panel3" runat="server" Height="529px">
                            ...
                            商品尚未結帳&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="Button2" runat="server" PostBackUrl="~/product/cart.aspx" Text="點我前往購物車" />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label2" runat="server"></asp:Label>
                            &nbsp;&nbsp;&nbsp; <asp:DataList ID="DataList2" runat="server" DataSourceID="SqlDataSource1" RepeatDirection="Horizontal" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="0" GridLines="Both" OnItemCommand="DataList2_ItemCommand" CssClass="auto-style7" RepeatColumns="4" Height="500px" Width="500px">
                                <FooterStyle BackColor="#99CCCC" ForeColor="#003399" />
                                <HeaderStyle BackColor="#003399" Font-Bold="True" ForeColor="#CCCCFF" />
                                <ItemStyle BackColor="#C8DCBC" ForeColor="#003399" />
                                <ItemTemplate>
